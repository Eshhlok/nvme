...
OUTPUT_FILE = "output/enhanced_cross_validation_results.csv"
...
print("========================================")
print("ENHANCED QUEUE FEATURE CV")
print("========================================")
print("Rows:", len(df))
...
for fold, (train_idx, test_idx) in enumerate(
    ...
    train_runs = sorted(df.iloc[train_idx]["run_id"].unique())
    test_runs = sorted(df.iloc[test_idx]["run_id"].unique())
...
print("\nImprovement:")
print(
    f"Accuracy: {(mean_accuracy - 0.9080) * 100:+.2f} percentage points"
)
print(
    f"Macro F1: {(mean_f1 - 0.9165) * 100:+.2f} percentage points"
)
